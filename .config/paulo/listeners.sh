...
declare -A LISTENERS
LISTENERS["low-bat-notification"]="$HOME/.config/paulo/listeners/low-bat-notification.sh"
# Example for another listener:
# LISTENERS["another-listener"]="$HOME/.config/paulo/listeners/another-listener.sh"
